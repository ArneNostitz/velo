    ...
    cards: [
      {
        ...
        tips: [
          ...
          { text: "Search starts in the current folder or label, across listed accounts when the unified inbox is on. All mail excludes Spam and Trash; All folders includes both. Switch scope below the search box without retyping." },
          { text: "Result pills show where each conversation lives. Search covers downloaded mail; uncached bodies cannot be searched yet. Punctuation is treated literally, and quoted phrases stay together." },
