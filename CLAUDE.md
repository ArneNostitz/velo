...
- `ui/` — EmptyState, Skeleton, ContextMenu, ContextMenuPortal, OfflineBanner, Tooltip, illustrations/ (InboxClearIllustration, NoAccountIllustration, NoSearchResultsIllustration, ReadingPaneIllustration, GenericEmptyIllustration)
...
153 test files across stores (8), services (82), utils (19), components (36), constants (4), router (1), hooks (3), and config (1).
