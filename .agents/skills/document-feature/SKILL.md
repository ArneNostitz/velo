...
description: Add help documentation for a new or changed feature. Updates the Help page content, project docs (docs/, AGENTS.md), and keeps counts accurate.
...
8. **Update project docs** if the feature affects them. Check each file and update as needed:
   ...
   - `AGENTS.md` — Update the relevant section (component organization, service layer, key gotchas, etc.) to reflect the new feature.
